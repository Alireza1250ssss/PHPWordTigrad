...
class Table extends AbstractElement
{
     ...
     * Table rows
     *
     * @var \Alireza1250ssss\PhpWord\Element\Row[]
     */
    private $rows = array();
     ...
     * @param int $height
     * @param mixed $style
     * @return \Alireza1250ssss\PhpWord\Element\Row
     */
     ...
     * @param int $width
     * @param mixed $style
     * @return \Alireza1250ssss\PhpWord\Element\Cell
     */
    ...
    public function countColumns()
    {
        ...
        for ($i = 0; $i < $rowCount; $i++) {
            /** @var \Alireza1250ssss\PhpWord\Element\Row $row Type hint */
            $row = $this->rows[$i];
