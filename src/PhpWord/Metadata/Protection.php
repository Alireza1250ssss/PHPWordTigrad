...
use Alireza1250ssss\PhpWord\SimpleType\DocProtect;
...
class Protection
{
    ...
    /**
     * Cryptographic Hashing Algorithm (see constants defined in \Alireza1250ssss\PhpWord\Shared\Microsoft\PasswordEncoder)
     *
     * @var string
     */
     ...
     *
     * @param string $editing Any value of \Alireza1250ssss\PhpWord\SimpleType\DocProtect
     * @return self
     */
