...
class PhpWord
{
     ...
     *
     * @var \Alireza1250ssss\PhpWord\Element\Section[]
     */
    ...
    public function __construct()
    {
        ...
        foreach ($collections as $collection) {
            $class = 'Alireza1250ssss\\PhpWord\\Collection\\' . $collection;
        ...
        foreach ($metadata as $meta) {
            $class = 'Alireza1250ssss\\PhpWord\\Metadata\\' . $meta;
    ...
    public function __call($function, $args)
    {
        ...
        if (in_array($function, $addCollection)) {
            ...
            /** @var \Alireza1250ssss\PhpWord\Collection\AbstractCollection $collectionObject */
        ...
        if (in_array($function, $addStyle)) {
            return forward_static_call_array(array('Alireza1250ssss\\PhpWord\\Style', $function), $args);
        }
     ...
     *
     * @return \Alireza1250ssss\PhpWord\Metadata\DocInfo
     */
     ...
     * Get protection
     *
     * @return \Alireza1250ssss\PhpWord\Metadata\Protection
     * @since 0.12.0
     ...
     * Get compatibility
     *
     * @return \Alireza1250ssss\PhpWord\Metadata\Compatibility
     * @since 0.12.0
     */
     ...
     * Get compatibility
     *
     * @return \Alireza1250ssss\PhpWord\Metadata\Settings
     * @since 0.14.0
     */
     ...
     * Get all sections
     *
     * @return \Alireza1250ssss\PhpWord\Element\Section[]
     */
     ...
     *
     * @param int $index
     * @return \Alireza1250ssss\PhpWord\Element\Section|null
     */
     ...
     * @deprecated 0.12.0
     *
     * @param \Alireza1250ssss\PhpWord\Metadata\DocInfo $documentProperties
     *
     * @return self
     *
     * @codeCoverageIgnore
