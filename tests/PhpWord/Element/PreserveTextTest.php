...
/**
 * Test class for Alireza1250ssss\PhpWord\Element\PreserveText
 *
...
class PreserveTextTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertInstanceOf('Alireza1250ssss\\PhpWord\\Element\\PreserveText', $oPreserveText);
    ...
    public function testConstructWithArray()
    {
        ...
        $this->assertInstanceOf('Alireza1250ssss\\PhpWord\\Style\\Font', $oPreserveText->getFontStyle());
        $this->assertInstanceOf('Alireza1250ssss\\PhpWord\\Style\\Paragraph', $oPreserveText->getParagraphStyle());
    }
}
