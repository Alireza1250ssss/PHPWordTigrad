...
namespace Alireza1250ssss\PhpWord\Reader\Word2007;

use Alireza1250ssss\PhpWord\AbstractTestReader;
use Alireza1250ssss\PhpWord\Element\TrackChange;

/**
 * Test class for Alireza1250ssss\PhpWord\Reader\Word2007\Element subnamespace
 */
class ElementTest extends AbstractTestReader
{
    ...
    public function testReadAlternateContent()
    {
        ...
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\TextRun', $elements[0]);
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\Text', $elements[0]->getElement(0));
        $text = $elements[0];
    ...
    public function testReadTextBreak()
    {
        ...
        $elements = $phpWord->getSection(0)->getElements();
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\TextRun', $elements[0]);
        /** @var \Alireza1250ssss\PhpWord\Element\TextRun $textRun */
        $textRun = $elements[0];
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\TextBreak', $textRun->getElement(0));
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\Text', $textRun->getElement(1));
    ...
    public function testSmartTag()
    {
        ...
        /** @var \Alireza1250ssss\PhpWord\Element\TextRun $textRun */
        $textRun = $elements[0];
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\Text', $textRun->getElement(0));
    ...
    public function testReadListItemRunWithFormatting()
    {
        ...
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\ListItemRun', $sections->getElement(0));
        $this->assertEquals(0, $sections->getElement(0)->getDepth());

        $listElements = $sections->getElement(0)->getElements();
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\Text', $listElements[0]);
    ...
    public function testReadTrackChange()
    {
        ...
        $elements = $phpWord->getSection(0)->getElements();
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\TextRun', $elements[0]);
        /** @var \Alireza1250ssss\PhpWord\Element\TextRun $elements */
        $textRun = $elements[0];
        ...
        /** @var \Alireza1250ssss\PhpWord\Element\TrackChange $trackChange */
    ...
    public function testReadTab()
    {
        ...
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\Text', $textRun->getElement(2));
    ...
    public function testReadTitleStyle()
    {
        ...
        $elements = $phpWord->getSection(0)->getElements();
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\Title', $elements[0]);
        /** @var \Alireza1250ssss\PhpWord\Element\Title $title */
        $title = $elements[0];
        $this->assertEquals('Title', $title->getStyle());
        $this->assertEquals('This is a non formatted title', $title->getText());

        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\Title', $elements[1]);
        /** @var \Alireza1250ssss\PhpWord\Element\Title $formattedTitle */
        $formattedTitle = $elements[1];
        $this->assertEquals('Title', $formattedTitle->getStyle());
        $this->assertInstanceOf('Alireza1250ssss\PhpWord\Element\TextRun', $formattedTitle->getText());
    }
