...
/**
 * Test class for Alireza1250ssss\PhpWord\Shared\Html
 * @coversDefaultClass \Alireza1250ssss\PhpWord\Shared\Html
 */
class HtmlTest extends AbstractWebServerEmbeddedTest
{
    ...
    public function testParseTableAndCellWidth()
    {
        ...
        $section = $phpWord->addSection(array(
            'orientation' => \Alireza1250ssss\PhpWord\Style\Section::ORIENTATION_LANDSCAPE,
        ));
