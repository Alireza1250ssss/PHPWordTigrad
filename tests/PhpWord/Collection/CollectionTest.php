...
namespace Alireza1250ssss\PhpWord\Collection;

use Alireza1250ssss\PhpWord\Element\Footnote;

/**
 * Test class for Alireza1250ssss\PhpWord\Collection subnamespace
 *
...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCollection()
    {
        ...
        $this->assertInstanceOf('Alireza1250ssss\\PhpWord\\Element\\Footnote', $object->getItem(1)); // getItem returns object
