...
namespace Alireza1250ssss\PhpWord\Writer\ODText\Style;
...
class SectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testHeaderFooterTabs()
    {
        ...
        $margins = \Alireza1250ssss\PhpWord\Shared\Converter::INCH_TO_TWIP;
        ...
        $phpWord->addParagraphStyle(
            ...
            array(
                'tabs' => array(
                    new \Alireza1250ssss\PhpWord\Style\Tab('center', (int) ($footerwidth / 2)),
                    new \Alireza1250ssss\PhpWord\Style\Tab('right', (int) $footerwidth),
                ),
            )
        );
    ...
    public function testHideErrors()
    {
        ...
        $phpWord->getSettings()->setThemeFontLang(new \Alireza1250ssss\PhpWord\Style\Language('en-US'));
        $phpWord->getSettings()->getThemeFontLang()->setLangId(\Alireza1250ssss\PhpWord\Style\Language::EN_US_ID);
