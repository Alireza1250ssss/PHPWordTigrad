...
$commentWithStartAndEnd = new \Alireza1250ssss\PhpWord\Element\Comment('Foo Bar', new \DateTime());
...
$commentOnImage = new \Alireza1250ssss\PhpWord\Element\Comment('Mr Smart', new \DateTime());
...
$comment1 = new \Alireza1250ssss\PhpWord\Element\Comment('Authors name', new \DateTime(), 'my_initials');
